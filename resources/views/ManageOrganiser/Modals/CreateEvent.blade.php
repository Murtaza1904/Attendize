<div role="dialog" class="modal fade" style="display: none;">
    ...
    {!! Form::open(['url' => route('postCreateEvent'), 'class' => 'ajax gf']) !!}
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group custom-theme">
                            {!! Form::label('description', trans('Event.event_description'), ['class' => 'control-label required']) !!}
                        ...
                        <div class="form-group">
                            {!! Form::label('event_image', trans('Event.event_image'), ['class' => 'control-label ']) !!}
                        ...
                        <div class="mb-3">
                            ...
                            <select name="region_tax_id" id="region_tax_id" class="form-control">
                                ...
                                @empty
                                    <option value="" class="text-danger" disabled>No region tax found!</option>
                                @endforelse
                            </select>
                        </div>
                        ...
                        @if (!empty(config('attendize.google_maps_geocoding_key')))
                            ...
                            <span>
                                <a data-clear-field=".location_field"
                                    ...
                                    data-show-less-text="@lang('Event.or(manual/existing_venue)') <b>@lang('Event.enter_existing')</b>"
                                    href="javascript:void(0);" class="in-form-link show-more-options clear_location">
                        ...
                        @else
                            <div class="create_organiser" style="{{ $organisers->isEmpty() ? '' : 'display:none;' }}">
                                ...
                                <div class="form-group">
                                    {!! Form::label('organiser_name', trans('Organiser.organiser_name'), ['class' => 'required control-label ']) !!}
                                ...
                                <div class="form-group">
                                    {!! Form::label('organiser_email', trans('Organiser.organiser_email'), ['class' => 'control-label required']) !!}
                                ...
                                <div class="form-group">
                                    {!! Form::label('organiser_about', trans('Organiser.organiser_description'), ['class' => 'control-label ']) !!}
                                ...
                                <div class="form-group more-options">
                                    {!! Form::label('organiser_logo', trans('Organiser.organiser_logo'), ['class' => 'control-label ']) !!}
                                    {!! Form::styledFile('organiser_logo') !!}
                                </div>
                                <div class="row more-options">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            {!! Form::label('organiser_facebook', trans('Organiser.organiser_facebook'), ['class' => 'control-label ']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            {!! Form::label('organiser_twitter', trans('Organiser.organiser_twitter'), ['class' => 'control-label ']) !!}
                            ...
                            @if (!$organisers->isEmpty())
                                <div class="form-group select_organiser"
                                    style="{{ $organisers ? '' : 'display:none;' }}">

                                    {!! Form::label('organiser_id', trans('Organiser.select_organiser'), ['class' => 'control-label ']) !!}

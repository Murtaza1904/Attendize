...
class SendOttawaNotificationMail extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->subject(' Complimentary OC Transpo and O-Train Access with Your Halal Ribfest Ottawa Ticket')
                    ->view('Emails.ottawa-event-mail');
    }
}
